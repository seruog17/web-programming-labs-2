...
if app.config['DB_TYPE'] == 'postgres':
    db_name = 'sergei_posagennikov_orm'
    db_user = 'sergei_posagennikov_orm'
    db_password = '123'
    host_ip = '127.0.0.1'
    host_port = 5432
    ...
    db_path = path.join(dir_path, "sergei_posagennikov_orm.db")
    app.config['SQLALSHEMY_DATABASE_URI'] = f'sqlite:///{db_path}'
